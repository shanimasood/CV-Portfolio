...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      'Enterprise lending product handling the full loan lifecycle — origination, disbursement, recovery, and securities — across every category a bank can lend in. Currently shipping to a major Pakistani bank as the first client.',
    category: 'product',
    status: 'shipping',
    tags: ['Vue 3', 'Node.js', 'Java Quarkus', 'PostgreSQL', 'Camunda', 'FinTech'],
    highlights: [
      'Loan lifecycle: Initiate → Disburse → Recover → Securities',
      'Categories: Consumer, SME, Agri, Corporate, Commercial, Leasing',
      'Products: Auto Loan, Personal Loan, Housing Finance, Renewable Energy',
      'Multi-tenant architecture ready for additional bank clients',
    ],
    featured: true,
  },
  {
  ...
  },
  {
    id: 'trixma',
    title: 'Trixma',
    subtitle: 'Mobile invoicing, without the bloat',
    description:
      'A personal React Native project — a clean, focused mobile invoicing app built end-to-end for freelancers and small businesses. Every product decision, every pixel, every animation is solo work.',
    category: 'mobile',
    status: 'personal',
    tags: ['React Native', 'JavaScript', 'Mobile UI', 'Solo Build'],
    highlights: [
      'End-to-end product design and engineering',
      'Cross-platform iOS & Android delivery',
      'Built to scratch a personal product itch',
    ],
    featured: true,
  },
];
